...
import pytorch_lightning.strategies.strategy as strategy_module

# Patch to load checkpoint non-strictly
original_load_model_state_dict = strategy_module.Strategy.load_model_state_dict

def patched_load_model_state_dict(self, checkpoint):
    """Load state dict without strict checking"""
    state_dict = checkpoint.get("state_dict", checkpoint)
    
    # Remove problematic DDIM keys
...
strategy_module.Strategy.load_model_state_dict = patched_load_model_state_dict
...
if __name__ == "__main__":
    ...
    try:
        ...
        def melk(*args, **kwargs):
            ...
            if trainer.global_rank == 0:
                print("Summoning checkpoint.")
                ckpt_path = os.path.join(ckptdir, "last_tuned.ckpt")
                trainer.save_checkpoint(ckpt_path)
